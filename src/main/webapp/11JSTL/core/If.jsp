...
-->
	...
	조건을 만들어서 2개의 if태그를 사용해야 한다.
	 -->
	<h4>문자열 비교와 else 구문 흉내내기</h4>
	<!-- Java에서는 비교연산자 ==rhk equals()가 다르지만, EL에서는 eq를
	통해 값에 대한 비교와 문자열에 대한 비교 모두를 할 수 있다.
	여기서 사용한 eq는 Java의 compardTo()와 같이 사전순으로 문자열을
	비교한다. -->
	...
	result4 : ${result4 } <br />
	<!-- 
	test에 조건을 추가할때 앞뒤로 공백이 하나라도 들어가면 무조건  
	false를 반환하므로 작성시 주의해야한다.
	 -->
	<c:if test=" ${true }" var= "result5">
		EL 양쪽에 빈 공백이 잇는 경우 false <br />
	</c:if>
	result5 : ${result5 } <br />
