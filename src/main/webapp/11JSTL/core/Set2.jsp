...
<body>
	...
	<%
	//Person 인스턴스를 저장할 수 잇는 List계열의 컬렉션 생성
	...
	<!-- 
	2개의 인스턴스 중 0번 인덱스를 출력. List는 인덱스로 접근할 수 있다.
	차후 forEach 태그를 사용하면 2개의 인스턴스 전체를 반복해서 출력할 수 
	있다.
	 -->
	<ul>
	...
	<%
	/* 
	Map의 Key는 String, Value는 Person타입으로 정의한 후 2개의
	인스턴스를 저장한다.
	*/
	...
	<!-- Map 컬렉션이므로 Key를 통해 접근하여 값을 추렭한다. -->
	<ul>
