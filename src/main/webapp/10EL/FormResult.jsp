...
<body>	 
	...
	paramValues : 2개 이상의 값을 받을때 사용한다. 단 이경우 배열을
		통해 값을 구분해야 한다.
	-->
    ...
    <ul>
        ...
        NullPointerException이 발생하지 않으므로 아래와 같이 기술해도
        문제없다. -->
    ...
    /*
    JSP내장객체를 통해 폼값을 받은 후 출력하는 경우 선택된 값이 1개밖에 
    없다면 예외가 발생하게된다. 이 경우 if문으로 값의 유무를 체크하거나
    예외처리를 해야하므로 EL에 비해서는 불편한 점이 있다.
    */
    %>
</body>
