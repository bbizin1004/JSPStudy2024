...
<body>
	...
	<!-- 
	4가지 영역에 접근할때는 EL 내장객체를 통해 내용을 출력한다.
	모두 동일한 패턴으로 "영역명 Scope"와 같은 형태로 되어있다.
	...
	즉 여기서는 page영역의 속성을 출력하게 된다. 실질적인 사용에서는 주로
	동일한 속성명으로 저장하는 경우가 없으므로 대부분 이와같이 사용할 수 있다.
	 -->
	...
	/*
	JSP 페이지에서 포워드는 위 2가지 방법을 사용할 수 있는데, 액션태그를 사용하면 좀 더 간편하게
	표현할 수 있다.
	현재 페이지로 들어온 요청을 포워드된 페이지로 전달한다.
	*/
	%>
</body>
</html>