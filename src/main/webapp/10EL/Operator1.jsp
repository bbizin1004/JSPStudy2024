...
<body>
    ...
    <!-- Tomcat8부터는 EL에서 변수할당을 할 수 없다. 하지만 변수할당과
    동시에 출력되므로, 할당문 뒤에 , ''을 붙여줘야 출력되지 않는다.
    즉, EL에서 변수할당은 거의 상ㅇ되지 않는다. -->
   ...
   El에서 +는 덧셈연산만 가능하고, 문자열의 연결에는 사용되지 않는다.
    ...
    <!--  
		...
		== : eq(EQual)
		!= : ne(Not Equal)
	EL에서는 Java에서 사용하던 기본적인 비교연산자와 문자형태의 연산자
	두가지 모두 사용할 수 있다. 
    -->
    <h3>비교 연산자</h3>
	...
	<!-- 
	논리 And,Or의 경우에도 아래와 같이 문자형태의 연산자를 사용할 수 있다.
	  -->
    <h3>논리 연산자</h3>
