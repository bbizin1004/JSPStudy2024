...
<body>
	<!-- 
	web.xml에 <context-param>으로 설정한 값을 내장객체를 통해 읽어올수 있다.
	  -->
	...
	디렉토리 하위에 프로젝트와 동일한 톰캣환경을 만든 후 복사본 파일을 
	실행하게 된다. 따라서 아래의 물리적경로는 그 하위의 경로가 출력된다.
	  -->
	application 내장 객체 :
	...
	<h2>선언부에서 application 내장 객체 사용하기</h2>
	 ...
	 선언부에서 사용하려면 매개변수로 전달받거나 또 다른 메서드를 
	 통해 얻어와야 한다.
	 -->
	...
	/*
	방법2 : JSP에서 호출할때 application 내장객체를 매개변수를 통해 전달한다.
	*/
