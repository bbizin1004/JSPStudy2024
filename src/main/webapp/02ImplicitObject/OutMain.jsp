...
<body>
	<%
	/*
	out내장객체를 통해 print() 메서드를 호출하면 전달된 내용이
	웨브라우저에 즉시 출력되지 ㅇ낳고 버퍼에 먼저 저장된다.
	*/
	out.print("출력되지 않는 텍스트");
	/*
	버퍼에 저장된 모든 내용을 삭제한다. 그러면 해당 내용은 브라우저에 출력되지
	않는다. '소스보기'로 확인해보면 상단의 <html>태그가 사라진걸 볼수 있다.
	*/
	out.clearBuffer();
	...
	웹브라우저에서는 줄바꿈을 위해 <br>태그가 필요하므로 두 메서드의 차이는 스페이스 한칸이
	들어가는 정도이다.*/
	%>
</body>
</html>