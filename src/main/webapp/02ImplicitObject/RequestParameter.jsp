...
<head>
<meta charset="UTF-8">
<title>내장 책체 -request</title>
</head>
<body>
<%
/*
Tomcat9까지는 post방식으로 한들을 전송하는 경우 한글깨짐 현상이 발생한다.
따라서 해당 코드가 필요하다. 하지만 Tomcat10.1에서는 생략해도 무방하다.
*/
...
저장된다. 따라서 웹브라우저에 출력할때는 <br>태그로 변경해야 한다.
*/
